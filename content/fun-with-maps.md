...
`lightings_15` layer and force redraw on that layer.
...
Finally after page load I'm setting interval using `setInverval` and defined
...
Check [example](http://utek.pl/examples/fun-with-maps/)

Todo:

- Some sort of cache of [Blitzortung.org](http://blitzortung.org/) layer
- Improve visibility
